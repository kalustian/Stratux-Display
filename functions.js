...
var oldX = 0;
var oldY = 0;
function trans(newX, newY, canvas){
  oldX = newX;
  oldY = newY;
  if(canvas === undefined){
    translate(newX, newY);
...
function trans_add(newX, newY, canvas){
  oldX += newX;
  oldY += newY;
  if(canvas === undefined){
    translate(newX, newY);
...
function rot_add(newRot, canvas){
  oldRot += newRot;
  if(canvas === undefined){
    rotate(newRot);
  }else{
...
function rot_rev(canvas){
  if(canvas === undefined){
    rotate(-oldRot);
  }else{
    canvas.rotate(-oldRot);
  }
}
